...
//       {/* 2. CONTENT WRAPPER (THE MISSING PART) */}
//       {/* The -mt-[100vh] pulls this content UP to overlap the sticky background */}
//       <div className="relative z-10 -mt-[100vh]"> 
        
//         {/* Add padding here instead so spacing is correct */}
...
// function TimelineItem({ item, index, isLeft, setMode, setActiveIndex }: any) {
//   const ref = useRef(null);
//   // Trigger slightly earlier (0.2) to update background smoothly
//   const isInView = useInView(ref, { margin: "-50% 0px -50% 0px", amount: 0.2 });
